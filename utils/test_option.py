...
def get_args_parser():
    ...
    WSI = subparsers.add_parser("WSI",
                                description='Dataset parser for training on WSI',
                                add_help=True,
                                formatter_class=argparse.ArgumentDefaultsHelpFormatter,
                                help="Dataset parser for training on WSI")
    WSI.add_argument('--data-name', default='WSI', type=str, help='Dataset name')
    WSI.add_argument("--train-dir", type=str, default='./data/WSI/train', help="WSI train directory")
    WSI.add_argument("--val-dir", type=str, default='./data/WSI/test', help="WSI val directory")
    WSI.add_argument("--test-dir", type=str, default='./data/WSI/test', help="WSI val directory")
